...
`vision` · requested 2026-09-20 · branch `claude/board-docs`
...
| File | Opens in |
|---|---|
| [docs/design/vision.md](https://github.com/Harwasch/MakeHardware/blob/claude/board-docs/docs/design/vision.md) | renders on GitHub |
...
| File | Opens in |
|---|---|
| [concepts](https://github.com/Harwasch/MakeHardware/blob/claude/board-docs/concepts) | download |
