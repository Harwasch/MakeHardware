...
`standby` · requested 2026-09-20 · branch `claude/closed-loop-extract`
...
| File | Opens in |
|---|---|
| [docs/design/iterations/standby.json](https://github.com/Harwasch/MakeHardware/blob/claude/closed-loop-extract/docs/design/iterations/standby.json) | plain text on GitHub |
| [docs/design/standby-results.md](https://github.com/Harwasch/MakeHardware/blob/claude/closed-loop-extract/docs/design/standby-results.md) | renders on GitHub |
...
The agent writes your decision, in your words, into [`docs/review/reviews.yaml`](https://github.com/Harwasch/MakeHardware/blob/claude/closed-loop-extract/docs/review/reviews.yaml):
