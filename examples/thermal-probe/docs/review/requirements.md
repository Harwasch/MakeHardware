...
`requirements` · requested 2026-09-20 · branch `claude/board-docs`
...
| File | Opens in |
|---|---|
| [requirements/00-vision.sdoc](https://github.com/Harwasch/MakeHardware/blob/claude/board-docs/requirements/00-vision.sdoc) | StrictDoc source |
| [requirements/10-system.sdoc](https://github.com/Harwasch/MakeHardware/blob/claude/board-docs/requirements/10-system.sdoc) | StrictDoc source |
| [requirements/hardware.sgra](https://github.com/Harwasch/MakeHardware/blob/claude/board-docs/requirements/hardware.sgra) | download |
