...
`cad` · requested 2026-09-20 · branch `claude/board-docs`
...
| File | Opens in |
|---|---|
| [cad/enclosure.py](https://github.com/Harwasch/MakeHardware/blob/claude/board-docs/cad/enclosure.py) | plain text on GitHub |
