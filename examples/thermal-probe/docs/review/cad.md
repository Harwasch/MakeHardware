...
`cad` · requested 2026-09-20 · branch `claude/closed-loop-extract`
...
| File | Opens in |
|---|---|
| [cad/enclosure.py](https://github.com/Harwasch/MakeHardware/blob/claude/closed-loop-extract/cad/enclosure.py) | plain text on GitHub |
