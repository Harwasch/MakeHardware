...
`cad` · requested 2026-09-10 · branch `claude/dreamy-darwin-cc8sz4`
...
| File | Opens in |
|---|---|
| [cad/enclosure.py](https://github.com/Harwasch/MakeHardware/blob/claude/dreamy-darwin-cc8sz4/cad/enclosure.py) | plain text on GitHub |
