...
`architecture` · requested 2026-09-04 · branch `claude/ai-schematic-pcb-practices-mdap63`
...
| File | Opens in |
|---|---|
| [hw/block-diagram.drawio](https://github.com/Harwasch/MakeHardware/blob/claude/ai-schematic-pcb-practices-mdap63/hw/block-diagram.drawio) | draw.io / VS Code extension |
| [hw/block-diagram.yaml](https://github.com/Harwasch/MakeHardware/blob/claude/ai-schematic-pcb-practices-mdap63/hw/block-diagram.yaml) | plain text on GitHub |
...
The agent writes your decision, in your words, into [`docs/review/reviews.yaml`](https://github.com/Harwasch/MakeHardware/blob/claude/ai-schematic-pcb-practices-mdap63/docs/review/reviews.yaml):
