...
`architecture` · requested 2026-09-20 · branch `claude/closed-loop-extract`
...
| File | Opens in |
|---|---|
| [hw/block-diagram.drawio](https://github.com/Harwasch/MakeHardware/blob/claude/closed-loop-extract/hw/block-diagram.drawio) | draw.io / VS Code extension |
| [hw/block-diagram.yaml](https://github.com/Harwasch/MakeHardware/blob/claude/closed-loop-extract/hw/block-diagram.yaml) | plain text on GitHub |
