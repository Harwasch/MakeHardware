...
`architecture` · requested 2026-09-20 · branch `claude/board-docs`
...
| File | Opens in |
|---|---|
| [hw/block-diagram.drawio](https://github.com/Harwasch/MakeHardware/blob/claude/board-docs/hw/block-diagram.drawio) | draw.io / VS Code extension |
| [hw/block-diagram.yaml](https://github.com/Harwasch/MakeHardware/blob/claude/board-docs/hw/block-diagram.yaml) | plain text on GitHub |
